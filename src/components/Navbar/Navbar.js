  ...
  return (
    <nav className="sticky top-0 left-0 w-full" style={{ zIndex: 1000 }}>
      ...
      <div
        ...
        ${isScrolled ? "bg-black/80 backdrop-blur-md" : "bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900/50 backdrop-blur-md"}
      `}
      >
        <div className="max-w-7xl mx-auto flex justify-center space-x-6">
          <ul className="hidden md:flex space-x-6">
            <li className="hover:text-yellow-400 cursor-pointer">Digital Services</li>
            <li className="hover:text-yellow-400 cursor-pointer">Amazon Services</li>
            <li className="hover:text-yellow-400 cursor-pointer">Kids Courses</li>
            <li className="hover:text-yellow-400 cursor-pointer">Female Courses</li>
            <li className="hover:text-yellow-400 cursor-pointer">E-Flyers</li>
            <li className="hover:text-yellow-400 cursor-pointer">Training Schedule</li>
            <li className="hover:text-yellow-400 cursor-pointer">Fee Structure</li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-black/70 backdrop-blur-md px-6 lg:px-12 py-3">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-white text-sm">
          ...
          <div className="text-yellow-500 font-bold text-sm bg-yellow-900 px-3 py-1 rounded-md">
            Pro Bootcamps 2025
          </div>
