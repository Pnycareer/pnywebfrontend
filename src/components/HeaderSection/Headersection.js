...
export default function HeaderSection({
  ...
  return (
    <section className="relative flex flex-col items-center justify-center h-auto pb-10 bg-gradient-to-r from-[#1B263B] via-[#475e5e] to-[#006d5f]">
      <div className="w-11/12 md:w-10/12 lg:w-8/12 mx-auto flex flex-col items-center justify-center p-6 md:p-10">
        ...
        <p className="text-sm md:text-xl text-gray-200 text-justify mt-4 max-w-4xl">
          {shortdescription}
        </p>
