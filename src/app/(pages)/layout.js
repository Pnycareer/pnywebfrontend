...
async function fetchFooterData() {
  ...
  const [categoriesPayload, coursesPayload] = await Promise.all([categoriesPromise, coursesPromise]);
...
export default async function PagesLayout({ children }) {
  ...
  return (
    <>
      ...
      <SpinWheelModalTrigger autoOpen={false} deferUntilInteraction delayMs={800} frequency="daily" />
      ...
      <Script id="ga-src" src="https://www.googletagmanager.com/gtag/js?id=G-JWSHEGQWHD" strategy="afterInteractive" />
