        ...
        <div className="flex flex-col gap-6">
          <div className="bg-blue-500 text-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm md:text-base">
              Our vision is to build a world where every young individual has the skills and knowledge to thrive in the digital age.
              We aim to be a catalyst for global innovation and socio-economic development.
            </p>
          </div>
          ...
          <div className="bg-red-500 text-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <p className="text-sm md:text-base">
              Our mission is to empower youth through accessible, high-quality digital training and courses.
              We strive to foster lifelong learning, inspire innovation, and create opportunities for personal and professional growth.
            </p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="mt-6 space-y-2 text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-semibold text-slate-800">
              PNY Trainings Empowers <span className="bg-red-500 text-white px-2 py-1 rounded-md">100K+</span>
            </h2>
            <p className="text-lg font-medium text-slate-700">
              Students Nationwide with Tech Education
            </p>
            <p className="text-2xl font-bold text-slate-900 mt-4">OUR Mission Digital Pakistan</p>
          </div>
        </div>
      </div>
    </section>
