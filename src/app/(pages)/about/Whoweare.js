      ...
      <div className="relative z-10 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center glassmorphic shadow-xl rounded-3xl p-8 md:p-12 bg-white/10 backdrop-blur-sm border border-white/20">
        ...
        <div className="text-black space-y-6">
          ...
          <h3 className="text-2xl text-red-500 font-semibold">
            PNY Trainings: A renowned IT Training institute in Pakistan since 2014
          </h3>
          <p className="text-lg leading-relaxed text-black">
            Offering professional IT diplomas and short courses for students and professionals seeking career growth.
            As pioneers in comprehensive training, we have helped thousands of students secure lucrative jobs in the expanding IT industry.
            With top-level industry experienced instructors and multiple branches nationwide, we are committed to empowering individuals in their IT journey.
            Join us today and unlock your potential in the world of technology.
          </p>
        </div>
